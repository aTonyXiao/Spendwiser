...
const googleAPIKey = "&radius=100&key=AIzaSyBjvCHsXdtG924_6DpetOLJPliM--FKWWQ"
export function MainScreen() {
    ...
    useEffect(() => {
        (async () => {
            ...
            fetch(googlePlaceSearchURL + location.coords.latitude + "," + location.coords.longitude + googleAPIKey)
